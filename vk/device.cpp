...
struct Device;
/// internal Device, protect precious.
struct iDevice {
    struct Pair {
        Texture *texture;
        Image   *image;
...
struct iPipelineData {
    ...
    iPipelineData(Device &device, UniformData &ubo, VertexData &vbo, IndexData &ibo,
...
///
iPipelineData::iPipelineData(std::nullptr_t n) { }
...
iPipelineData::iPipelineData(Device        &dev,     UniformData &ubo,
...
void iPipelineData::update(size_t frame_id) {
}
